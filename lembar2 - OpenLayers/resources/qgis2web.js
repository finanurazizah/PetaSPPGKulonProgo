...
map.getView().fit([12234971.746020, -892818.002359, 12286203.925928, -852210.007225], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Tingkat Keterjangkauan Distribusi MBG Berdasarkan Waktu Tempuh</h2>';
        return titleElement;
    })(),
