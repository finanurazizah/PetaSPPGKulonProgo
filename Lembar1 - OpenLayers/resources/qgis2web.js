...
map.getView().fit([12244091.267317, -887112.553211, 12282077.757780, -852259.395872], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Pemetaan Distribusi Makan Bergizi Gratis (MBG) Kabupaten Kulon Progo</h2>';
        return titleElement;
    })(),
